...
$category = 'college';
$candidate_table = 'tblcollegecandidate';
...
<head>
    ...
    <title>Election Results - College</title>
...
<body>
    ...
    <main class="results-container">
        <h2>College Election Results</h2>
        ...
        <div class="actions">
            <a href="vote_college.php" class="btn-primary">Back to Voting</a>
        </div>
    </main>
</body>
</html>