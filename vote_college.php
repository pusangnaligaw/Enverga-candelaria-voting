...
$candidates = [];
$stmt = $conn->prepare("SELECT * FROM tblcollegecandidate ORDER BY position ASC");
$stmt->execute();
...
<body>
    ...
    <div class="welcome-banner">Welcome to College Voting, <?php echo htmlspecialchars($_SESSION['fullname'] ?? $_SESSION['userID']); ?>!</div>
    <h2>College Voting Page</h2>
    <div class="nosched">
        <?php if (!$schedule) {
        ...
        <?php if ($already_voted): ?>
            <div class="alert alert-success">
                ...
                <a href="results_college.php" class="btn-primary">View Results</a>
            </div>
