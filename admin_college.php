...
// Get all candidates
$candidates = [];
$stmt = $conn->prepare("SELECT * FROM tblcollagecandidate ORDER BY position ASC");
$stmt->execute();
...
<body>
    <header>
        <nav class="navbar">
            ...
            <h1>MSEUF Online Voting System - <?php echo ucfirst($category); ?></h1>
    ...
    <main class="admin-container">
                ...
                <tbody>
                    <?php foreach ($candidates as $position => $cands): ?>
                        ...
                        <tr>
                            <td>
                                <?php if ($cand['photo']): ?>
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($cand['photo']); ?>" 
                                         alt="Photo" class="candidate-thumb">
                                <?php else: ?>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="update_candidate.php?id=<?php echo $cand['id']; ?>&category=<?php echo $category; ?>" 
                                       class="btn-edit">Edit</a>
                                    <a href="?delete_candidate=<?php echo $cand['id']; ?>" class="btn-danger" 
        ...
        <div id="schedule" class="tab-content">
            ...
            <form action="admin_college.php" method="POST" class="schedule-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="start_datetime"
                               value="<?php echo $schedule ? date('Y-m-d\TH:i', strtotime($schedule['start_datetime'])) : ''; ?>" required>
                    </div>

                    <div class="form-group">
                        <label>End Date & Time *</label>
                        <input type="datetime-local" name="end_datetime"
                               value="<?php echo $schedule ? date('Y-m-d\TH:i', strtotime($schedule['end_datetime'])) : ''; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <?php if ($schedule): ?>
                        <button type="button" class="btn-danger" onclick="deleteSchedule()">Delete Schedule</button>
                    <?php endif; ?>
                </div>
            </form>
            ...
            <?php if ($schedule): ?>
                <div class="current-schedule">
                    ...
                    <div class="schedule-info">
                        <p><strong>Start:</strong> <?php echo date('M d, Y H:i', strtotime($schedule['start_datetime'])); ?></p>
                        <p><strong>End:</strong> <?php echo date('M d, Y H:i', strtotime($schedule['end_datetime'])); ?></p>
        ...
        <div id="results" class="tab-content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <h3>Total Voters</h3>
                    <p class="stat-number"><?php echo $voter_info['total_voters']; ?></p>
                </div>
                <div class="stat-card">
                ...
                <div class="stat-card">
                    ...
                    <p class="stat-number"><?php echo $stats['total_votes']; ?></p>
                </div>
            </div>
            
            <div class="results-actions">
                <a href="../results/results_<?php echo $category; ?>.php" class="btn-primary">View Detailed Results</a>
                <a href=" result_hs.php" class="btn-secondary">Export Results</a>
            </div>
        </div>
    </main>
