...
$category = 'highschool';
$candidate_table = 'tblhscandidate';
...
<head>
    ...
    <title>Election Results - High School</title>
...
<body>
    ...
    <main class="results-container">
        <h2>High School Election Results</h2>
        ...
        <div class="actions">
            <?php if ($_SESSION['type'] === 'admin'): ?>
                <a href="admin_highschool.php" class="btn-secondary">Admin Dashboard</a>
            <?php elseif ($_SESSION['type'] === 'student'): ?>
                <a href="vote_highschool.php" class="btn-secondary">Back to Voting Page</a>
            <?php endif; ?>
        </div>
    </main>
</body>
