...
// Get all candidates
$candidates = [];
$stmt = $conn->prepare("SELECT * FROM tbelementarycandidate ORDER BY position ASC");
$stmt->execute();
...
<body>
    ...
    <main class="admin-container">
        ...
        <div id="schedule" class="tab-content">
            ...
            <form action="admin_dashboard.php" method="POST" class="schedule-form">
    ...
    <div id="addCandidateModal" class="modal">
        <div class="modal-content">
            ...
            <form action="add_candidate.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Bio</label>
                    <textarea name="bio" rows="4" placeholder="Candidate biography..."></textarea>
                </div>
