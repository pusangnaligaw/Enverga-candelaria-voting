...
$candidates = [];
$stmt = $conn->prepare("SELECT * FROM tblhscandidate ORDER BY position ASC");
$stmt->execute();
...
<body>
    ...
    <main class="voting-container">
        <?php if (!empty($_SESSION['fullname'])): ?>
            <div class="welcome-banner">Welcome to High School Voting, <?php echo htmlspecialchars($_SESSION['fullname']); ?>!</div>
        <?php else: ?>
            <div class="welcome-banner">Welcome to High School Voting!</div>
        <?php endif; ?>
        <h2>High School Voting Page</h2>
         <div class ="nosched">
    </div>
        <?php if ($already_voted): ?>
            <div class="alert alert-success">
                ...
                <a href="results_highschool.php" class="btn-primary">View Results</a>
            </div>
